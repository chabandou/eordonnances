...
export default function CardsWithSpecialty({ specialty, diseases }) {
  return (
    <AnimatePresence>
      <div className="specialty-h w-[90%] lg:w-3/4 flex flex-col items-center lg:items-start m-2 mt-4">
        <span
          key={specialty}
      ...
      <motion.div
        ...
        className="w-full grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 place-items-center gap-x-4 "
      >
        {diseases.map((d, i) => (
          <AnimatePresence>
